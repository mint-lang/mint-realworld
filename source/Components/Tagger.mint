component Tagger {
      ...
      >
        <path
          d={
            ...
            "12-12-5.373-12-12-12zm4.151 17.943l-4.143-4.102-4.117 " \
            "4.159-1.833-1.833 4.104-4.157-4.162-4.119 1.833-1.833 4.155 " \
  ...
  fun render : Html {
    <div::base>
      ...
      <div::tags>Set.toArray(Set.map(tags, renderTag))</div>
    </div>
  }
}
